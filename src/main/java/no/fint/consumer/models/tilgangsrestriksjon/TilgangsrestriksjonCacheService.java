...
public class TilgangsrestriksjonCacheService extends CacheService<TilgangsrestriksjonResource> {
    ...
    public TilgangsrestriksjonCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_TILGANGSRESTRIKSJON, KodeverkActions.UPDATE_TILGANGSRESTRIKSJON);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_TILGANGSRESTRIKSJON, Constants.CACHE_SERVICE);
