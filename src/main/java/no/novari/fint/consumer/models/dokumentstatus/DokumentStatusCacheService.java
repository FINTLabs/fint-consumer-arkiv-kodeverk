...
public class DokumentStatusCacheService extends CacheService<DokumentStatusResource> {
    ...
    public DokumentStatusCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_DOKUMENTSTATUS, KodeverkActions.UPDATE_DOKUMENTSTATUS);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_DOKUMENTSTATUS, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_DOKUMENTSTATUS) {
