...
public class JournalpostTypeCacheService extends CacheService<JournalpostTypeResource> {
    ...
    public JournalpostTypeCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_JOURNALPOSTTYPE, KodeverkActions.UPDATE_JOURNALPOSTTYPE);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_JOURNALPOSTTYPE, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_JOURNALPOSTTYPE) {
