...
import no.novari.fint.model.arkiv.kodeverk.Rolle;
...
public class RolleCacheService extends CacheService<RolleResource> {
    ...
    public RolleCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_ROLLE, KodeverkActions.UPDATE_ROLLE);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_ROLLE, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_ROLLE) {
