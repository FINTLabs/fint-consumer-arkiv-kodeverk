...
public class RolleController {
    ...
    public RolleResources getRolle(
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_ROLLE, client);
    ...
    private RolleResources getRolleByOdataFilter(
        ...
        Event event = new Event(
                ...
                KodeverkActions.GET_ROLLE, client);
        event.setOperation(Operation.READ);
    ...
    public RolleResource getRolleBySystemId(
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ROLLE, client);
        event.setOperation(Operation.READ);
