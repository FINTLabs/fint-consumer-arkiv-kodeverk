...
public class SaksstatusCacheService extends CacheService<SaksstatusResource> {
    ...
    public SaksstatusCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_SAKSSTATUS, KodeverkActions.UPDATE_SAKSSTATUS);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_SAKSSTATUS, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_SAKSSTATUS) {
