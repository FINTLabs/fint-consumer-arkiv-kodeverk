...
public class SkjermingshjemmelCacheService extends CacheService<SkjermingshjemmelResource> {
    ...
    public SkjermingshjemmelCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_SKJERMINGSHJEMMEL, KodeverkActions.UPDATE_SKJERMINGSHJEMMEL);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_SKJERMINGSHJEMMEL, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_SKJERMINGSHJEMMEL) {
