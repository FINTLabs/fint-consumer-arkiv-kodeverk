...
public class TilknyttetRegistreringSomCacheService extends CacheService<TilknyttetRegistreringSomResource> {
    ...
    public TilknyttetRegistreringSomCacheService() {
        super(MODEL, KodeverkActions.GET_ALL_TILKNYTTETREGISTRERINGSOM, KodeverkActions.UPDATE_TILKNYTTETREGISTRERINGSOM);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, KodeverkActions.GET_ALL_TILKNYTTETREGISTRERINGSOM, Constants.CACHE_SERVICE);
    ...
    public void onAction(Event event) {
        ...
        if (KodeverkActions.valueOf(event.getAction()) == KodeverkActions.UPDATE_TILKNYTTETREGISTRERINGSOM) {
